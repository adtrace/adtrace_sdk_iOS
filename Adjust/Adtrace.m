...
+ (void)appDidLaunch:(ADJConfig *)adtraceConfig {
...
+ (void)setTestOptions:(AdjustTestOptions *)testOptions {
    ...
    [[Adtrace getInstance] setTestOptions:(AdjustTestOptions *)testOptions];
}
...
- (void)appDidLaunch:(ADJConfig *)adtraceConfig {
    ...
    self.activityHandler = [ADJAdjustFactory activityHandlerWithConfig:adtraceConfig
