...
static NSString * const kClientSdk                  = @"ios1.0.0";
...
+ (NSDictionary *)buildSignatureParameters:(NSMutableDictionary *)parameters
    ...
    [ADTUtil checkAndAddEntry:signatureParameters key:appSecretName value:appSecret];
    ...
    [ADTUtil checkAndAddEntry:signatureParameters key:sourceName value:parameters[sourceName]];
    [ADTUtil checkAndAddEntry:signatureParameters key:payloadName value:parameters[payloadName]];
