...
NSString * const ADTAdRevenueSourceAdmob = @"admob";
NSString * const ADTAdRevenueSourceFbNativeAd = @"facebook_native_ad";
NSString * const ADTAdRevenueSourceIronsource = @"ironsource";
NSString * const ADTAdRevenueSourceFyber = @"fyber";
NSString * const ADTAdRevenueSourceAerserv = @"aerserv";
NSString * const ADTAdRevenueSourceAppodeal = @"appodeal";
NSString * const ADTAdRevenueSourceAdincube = @"adincube";
NSString * const ADTAdRevenueSourceFusePowered = @"fusepowered";
NSString * const ADTAdRevenueSourceAddaptr = @"addapptr";
NSString * const ADTAdRevenueSourceMillennialMeditation = @"millennial_mediation";
NSString * const ADTAdRevenueSourceFlurry = @"flurry";
NSString * const ADTAdRevenueSourceAdmost = @"admost";
NSString * const ADTAdRevenueSourceDeltadna = @"deltadna";
NSString * const ADTAdRevenueSourceUpsight = @"upsight";
