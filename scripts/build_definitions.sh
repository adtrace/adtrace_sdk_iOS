...
if [ -z ${XCF_OUTPUT_FOLDER+x} ]; then 
  	...
  	function usage(){
  		...
  		echo -e "${RED}[ADTRACE][BUILD]:${GREEN}
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Usage: $0 [options]
...
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -${NC}"
	...
	SCHEMA_NAME__ADTRACE_IOS="AdtraceSdk"
	SCHEMA_NAME__ADTRACE_TV="AdtraceSdkTv"
	SCHEMA_NAME__ADTRACE_IM="AdtraceSdkIm"
	SCHEMA_NAME__ADTRACE_WEB_BRIDGE="AdtraceSdkWebBridge"

	# SDK Schema names - Static
	SCHEMA_NAME__ADTRACE_IOS_STATIC="AdtraceSdkStatic"
	SCHEMA_NAME__ADTRACE_TV_STATIC="AdtraceSdkTvStatic"
	SCHEMA_NAME__ADTRACE_IM_STATIC="AdtraceSdkImStatic"
	SCHEMA_NAME__ADTRACE_WEB_BRIDGE_STATIC="AdtraceSdkWebBridgeStatic"

	# SDK frameworks and xcframework names
	XCF_FRM_NAME__ADTRACE_IOS="AdtraceSdk"
	XCF_FRM_NAME__ADTRACE_TV="AdtraceSdkTv"
	XCF_FRM_NAME__ADTRACE_IM="AdtraceSdkIm"
	XCF_FRM_NAME__ADTRACE_WEB_BRIDGE="AdtraceSdkWebBridge"

	# xcode archive names
	ARCHIVE_NAME__IOS_DEVICE="AdtraceSdk-Device"
	ARCHIVE_NAME__IOS_SIMULATOR="AdtraceSdk-Simulator"
	ARCHIVE_NAME__TV_DEVICE="AdtraceSdkTv-Device"
	ARCHIVE_NAME__TV_SIMULATOR="AdtraceSdkTv-Simulator"
	ARCHIVE_NAME__IM_DEVICE="AdtraceSdkIm-Device"
	ARCHIVE_NAME__IM_SIMULATOR="AdtraceSdkIm-Simulator"
	ARCHIVE_NAME__WEB_DEVICE="AdtraceSdkWebBridge-Device"
	ARCHIVE_NAME__WEB_SIMULATOR="AdtraceSdkWebBridge-Simulator"

	# XCFrameworks and Frameworks archive (ZIP) names
	XCF_FRM_ZIP_NAME__IOS_TV_DYNAMIC="AdtraceSdk-iOS-tvOS-Dynamic"
	XCF_FRM_ZIP_NAME__IOS_TV_STATIC="AdtraceSdk-iOS-tvOS-Static"
	XCF_FRM_ZIP_NAME__IOS_DYNAMIC="AdtraceSdk-iOS-Dynamic"
	XCF_FRM_ZIP_NAME__IOS_STATIC="AdtraceSdk-iOS-Static"
	XCF_FRM_ZIP_NAME__TV_DYNAMIC="AdtraceSdk-tvOS-Dynamic"
	XCF_FRM_ZIP_NAME__TV_STATIC="AdtraceSdk-tvOS-Static"
	XCF_FRM_ZIP_NAME__IM_DYNAMIC="AdtraceSdk-iMessage-Dynamic"
	XCF_FRM_ZIP_NAME__IM_STATIC="AdtraceSdk-iMessage-Static"
	XCF_FRM_ZIP_NAME__WEB_BRIDGE_DYNAMIC="AdtraceSdk-WebBridge-Dynamic"
	XCF_FRM_ZIP_NAME__WEB_BRIDGE_STATIC="AdtraceSdk-WebBridge-Static"
  ...
  echo -e "${CYAN}[ADTRACE][BUILD]:${YELLOW} The definitions script has been already executed. Skipping it... ${NC}"
