...
echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Executing definitions script... ${NC}"
source ./scripts/build_definitions.sh "$@"
echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Executing definitions script - Done! ${NC}"

# ======================================== #

if [[ $BUILD_DYNAMIC_FRAMEWORK -eq 1 ]]
then
  echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Bulding Dynamic Frameworks... ${NC}"
  source ./scripts/dynamic_frameworks.sh
  echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Bulding Dynamic Frameworks - Done! ${NC}"
fi
# ======================================== #

if [[ $BUILD_STATIC_FRAMEWORK -eq 1 ]]
then
  echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Bulding Static Frameworks... ${NC}"
  source ./scripts/static_frameworks.sh
  echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Bulding Static Frameworks - Done! ${NC}"
fi
...
then
  echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Bulding Dynamic XCFrameworks... ${NC}"
  source ./scripts/dynamic_xcframeworks.sh
  echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Bulding Dynamic XCFrameworks - Done! ${NC}"
fi
...
then
  echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Bulding Static XCFrameworks... ${NC}"
  source ./scripts/static_xcframeworks.sh
  echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Bulding Static XCFrameworks - Done! ${NC}"
fi
...
then
  echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Bulding Test Framework... ${NC}"
  source ./scripts/build_test_framework.sh
  echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Bulding Test Framework - Done! ${NC}"
fi
