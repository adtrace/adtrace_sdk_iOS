...
echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Dynamic Frameworks build - START... ${NC}"
...
echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Moving shared schemas to generate dynamic iOS SDK framework using Carthage ... ${NC}"
...
then
  echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Bulding dynamic iOS target with Carthage ... ${NC}"
...
echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Moving shared schemas to generate dynamic tvOS SDK framework using Carthage ... ${NC}"
mv Adtrace.xcodeproj/xcshareddata/xcschemes/AdtraceSdk.xcscheme .
mv AdtraceSdkTv.xcscheme Adtrace.xcodeproj/xcshareddata/xcschemes
echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Done! ${NC}"
...
then
  echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Bulding dynamic tvOS targets with Carthage ... ${NC}"
  arch -x86_64 /bin/bash ./scripts/carthage_xcode.sh build --no-skip-current
  echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Done! ${NC}"
...
mv Adtrace.xcodeproj/xcshareddata/xcschemes/AdtraceSdkTv.xcscheme .
...
then
  ...
  echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Skipping WebBridge SDK framework build ... ${NC}"
fi
...
echo -e "${CYAN}[ADTRACE][BUILD]:${GREEN} Dynamic Frameworks build - END... ${NC}"
